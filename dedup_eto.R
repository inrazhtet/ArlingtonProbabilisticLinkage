...
########################################################
## Deduplicating all Eto system
## Anasazi code in Sayali's src folder
## Webvision deduplication code in Zarni's src
## The Full three deduplicate latest code is in Zarni's src.
...
# Objective: To find the most common value in a particular column
...
#### From a system design standpoint:How can you have the same system ID and 
#### have multiple entries with different demographic variables input?
################################################################################################
...
#### We increased the weights because for the imperfect matches, less than 50
#### in the cut-off score no longer makes sense. May need to examine underlying issue later.
#################################################################################################
...
#These are the System ID pairs that are NOT the same.
